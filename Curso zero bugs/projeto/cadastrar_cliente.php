...
if(count($_POST) > 0) {
    ...
    if(!empty($telefone)) {
        ...
        if(strlen($telefone) != 11) {
            $erro = "O telefone deve ser preenchido no padão (48) 99999-9999";
        }
    }
...
<body>
    ...
    <form method="post" action="">
        ...
        <p>
            ...
            <input value="<?php if(isset($_POST['telefone'])) echo $_POST['telefone']; ?>" placeholder="(48) 99999-9999" name="telefone" type="text">
        </p>
